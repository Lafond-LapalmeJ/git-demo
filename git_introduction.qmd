...
Gitlab and Github are web-based Git repository hosting platform used to:
...
There is many useful VScode extensions for git like [GitLens](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens)
